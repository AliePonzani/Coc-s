...
func getAllDrink2(url: String) async throws -> [Drink] {
    guard let url2 = URL(string: "https://www.thecocktaildb.com/api/json/v1/1/\(url)") else {
        throw GHError.invalidURL
    }
